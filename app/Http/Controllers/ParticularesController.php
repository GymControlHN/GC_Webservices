...
class ParticularesController extends Controller
{
    ...
    public function index () {
        ...
        //session()->flashInput([]);
        return view('particulares')->with('particulares' , $clientes)->with('no',0)->with("totalParticulares",$totalParticulares)
    ...
    public function buscarParticular(Request $request){
        ...
        return view('particulares')->with('particulares', $particulares)->with('no',1)->withIngresos($totalIngresos);
