    ...
    <!-- codigo para mostrar el nombre de cada cliente -->
        ...
        href="{{route("pagoparticulares",["id"=>$nombre->id])}}"
           ...
           href="{{route("pagoestudiantes",["id"=>$nombre->id])}}" @endif >Pagos</a>
            ...
            <a class="btn btn-secondary btn-sm" href="{{route("imc.ini",[$nombre->id])}}">Medidas Antropométicas</a>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" action="{{route('pagoparticulares.guardar')}}">
                                ...
                                <h6>Agregar Nota</h6>
                                <div class="form-group">
                                    <input type="text" class="form-control" maxlength="50" id="nota" name="nota"
                                           @isset($user)
                                           value="{{$user->nota}}"
                                            @endisset
                                    >
            ...
            @foreach ($pagos as $day => $users_list)
                ...
                @foreach ($users_list as $user)
                    <tr>
                        ...
                        @endif
                        <th>
                            <button class="btn btn-outline-warning btn-sm"  style="padding-left: 8px; padding-right: 8px" data-toggle="modal" data-target="#editarPagoParticular" data-myfecha="{{$user->fecha_pago}}"
